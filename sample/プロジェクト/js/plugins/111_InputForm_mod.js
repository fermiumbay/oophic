...
// PUBLIC DOMAIN
// ----------------------------------------------------------------------------
// 本プラグインは、InputForm.jsを他者(フェルミウム湾)が改変したものです。
// オリジナル版の著作権はくらむぼん様にございます。
// 
// 【改変内容】
// ・複数行の入力ボックスになるよう、inputタグをtextareaタグに変更しました。
// 
// ----------------------------------------------------------------------------
...
(function() {
    ...
    (function(){
        ...
        css.rel = "stylesheet";
        css.type = 'text/css';
        css.href = './css/111_InputForm_mod.css';
    ...
    if (PluginManager.registerCommand) {
        PluginManager.registerCommand("111_InputForm_mod", "show", function(args) {
    ...
    Game_Interpreter.prototype._inputForm = function(target_x, target_y, variables_id, max_count, if_switch_id, button_x, button_y, unit_font_size, placeholder) {
            ...
            var gui = {
                ...
                create : function(){
                    ...
                    this.submit.setAttribute('value', '閉じる');
